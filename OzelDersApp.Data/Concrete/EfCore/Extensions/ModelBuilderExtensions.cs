...
namespace OzelDersApp.Data.Concrete.EfCore.Extensions
{
    public static class ModelBuilderExtensions
    {
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            {
                //Admin
                new User {FirstName="Canan", LastName="Elif", UserName="cananelif", NormalizedUserName="CANANELIF", Email="cananelif@hotmail.com", NormalizedEmail="CANANELIF@HOTMAIL.COM", Gender="Kadın", DateOfBirth= new DateTime(2000,8,11), City="İstanbul",Phone = "5555555555",EmailConfirmed=true,ImageId = 5},
                //Students
