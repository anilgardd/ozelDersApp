...
using OzelDersApp.WebUI.Models.ViewModels.AccountModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string token)
        {
            ...
            if (user != null)
            {
                ...
                if (result.Succeeded)
                {
                    TempData["Message"] = Jobs.CreateMessage("Başarılı", "Profiliniz başarıyla onaylanmıştır.", "success");
                    return View();
                }
            }
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            {
                TempData["Message"] = Jobs.CreateMessage("HATA!", "Lütfen mail adresinizi yazınız!", "warning");
            }
